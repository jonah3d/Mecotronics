...
public class Occupation extends com.matisse.reflect.MtObject {
    ...
    /* Index 'OccupationName_IDX' */

    /** Index <code>OccupationName_IDX</code> cache ID */
    private static int occupationName_IDXIndexCID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtIndex.Loader("com.joe.models.OccupationName_IDX"));

    /**
     * Gets the <code>OccupationName_IDX</code> index descriptor.
     * This method supports advanced MATISSE programming techniques such as
     * dynamically modifying the schema.
     * @param db a database
     * @return an index descriptor object
     */
    public static com.matisse.reflect.MtIndex getOccupationName_IDXIndex(com.matisse.MtDatabase db) {
        return (com.matisse.reflect.MtIndex)db.getCachedObject(occupationName_IDXIndexCID);
    }

    /**
     * Finds one <code>Occupation</code> object in index <code>OccupationName_IDX</code>.
     * @param db a database
     * @param name search parameter
     * @return the matching <code>Occupation</code> object or <code>null</code> if none was found
     */
    public static Occupation lookupOccupationName_IDX(com.matisse.MtDatabase db, String name) {
        return (Occupation)getOccupationName_IDXIndex(db).lookup(new Object[] {name}, getClass(db));
    }

    /**
     * Finds <code>Occupation</code> objects in index <code>OccupationName_IDX</code>.
     * @param db a database
     * @param name search parameter
     * @return the matching <code>Occupation</code> objects or an empty array if none was found
     */
    public static Occupation[] lookupObjectsOccupationName_IDX(com.matisse.MtDatabase db, String name) {
        return (Occupation[])getOccupationName_IDXIndex(db).lookupObjects(new Object[] {name}, getClass(db), Occupation.class);
    }

    /**
     * Opens an iterator on index <code>OccupationName_IDX</code> for class <code>Occupation</code>.
     ...
     * @return an object iterator
     */
    public static <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> occupationName_IDXIterator(com.matisse.MtDatabase db, String fromName, String toName) {
        return getOccupationName_IDXIndex(db).<E>iterator(new Object[] {fromName}, new Object[] {toName}, getClass(db), com.matisse.reflect.MtIndex.DIRECT, com.matisse.MtDatabase.MAX_PREFETCHING, Occupation.class);
    }
     ...
     * @return an object iterator
     */
    public static <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> occupationName_IDXIterator(com.matisse.MtDatabase db, String fromName, String toName, com.matisse.reflect.MtClass filterClass, int direction, int numObjPerBuffer) {
        return getOccupationName_IDXIndex(db).iterator(new Object[] {fromName}, new Object[] {toName}, filterClass, direction, numObjPerBuffer, Occupation.class);
    }
